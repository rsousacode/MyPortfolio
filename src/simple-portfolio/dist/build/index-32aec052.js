...
import { i as identity, S as SvelteComponentDev, a as init, s as safe_not_equal, d as dispatch_dev, c as create_slot, v as validate_slots, b as createEventDispatcher, e as element, f as claim_element, g as children, h as detach_dev, j as set_style, k as attr_dev, t as toggle_class, l as add_location, m as insert_dev, n as action_destroyer, u as update_slot, o as transition_in, p as transition_out, q as globals, r as validate_each_argument, w as text, x as space, y as claim_text, z as claim_space, A as append_dev, B as check_outros, C as add_render_callback, D as create_bidirectional_transition, E as destroy_each, F as listen_dev, G as set_data_dev, H as group_outros, I as create_in_transition, J as create_out_transition, K as is_function } from './main-dc98cdbc.js';
...
const typewriter = async (node, options) => {
	const { default: mode } =
		(options.loop && (await import('./loop-461a6955.js'))) ||
		(options.cascade && (await import('./cascade-cbe813ba.js'))) ||
		(options.scramble && (await import('./scramble-a898ef8d.js'))) ||
		(await import('./default-93297434.js'));
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div0, file$1, 145, 16, 5353);
			attr_dev(div1, "class", "flex-item");
			add_location(div1, file$1, 144, 12, 5313);
			attr_dev(div2, "class", "flex-container mt-4");
			add_location(div2, file$1, 143, 8, 5222);
		},
		m: function mount(target, anchor) {
...
// (154:28) {#if getProjectVisibility(name)}
function create_if_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(p, file$1, 155, 36, 5984);
			...
			add_location(img, file$1, 158, 72, 6296);
			attr_dev(span, "class", "link");
			add_location(span, file$1, 160, 44, 6478);
			attr_dev(a, "href", a_href_value = /*github*/ ctx[11]);
			attr_dev(a, "target", "_blank");
			attr_dev(a, "class", "link");
			add_location(a, file$1, 157, 40, 6205);
			add_location(div0, file$1, 156, 36, 6100);
			add_location(div1, file$1, 154, 32, 5942);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(154:28) {#if getProjectVisibility(name)}",
		ctx
	});
...
function create_if_block_2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "icon");
			add_location(img, file$1, 165, 76, 6758);
			attr_dev(span, "class", "link");
			add_location(span, file$1, 167, 48, 6942);
			attr_dev(a, "href", a_href_value = /*website*/ ctx[12]);
			attr_dev(a, "target", "_blank");
			attr_dev(a, "class", "link");
			add_location(a, file$1, 164, 44, 6662);
		},
		m: function mount(target, anchor) {
...
// (148:16) {#each props.projects as {name, description, id, github, website}}
function create_each_block(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(148:16) {#each props.projects as {name, description, id, github, website}}",
		ctx
	});
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div0, file$1, 129, 16, 4398);
			attr_dev(div1, "class", "position");
			add_location(div1, file$1, 130, 16, 4471);
			...
			add_location(img2, file$1, 137, 76, 4950);
			attr_dev(a2, "href", a2_href_value = /*props*/ ctx[0].twitter);
			attr_dev(a2, "target", "_blank");
			attr_dev(a2, "class", "link ml-4");
			add_location(a2, file$1, 137, 16, 4890);
			attr_dev(div2, "class", "author-card");
			add_location(div2, file$1, 128, 12, 4356);
			attr_dev(div3, "class", "flex-item");
			add_location(div3, file$1, 127, 8, 4320);
			attr_dev(div4, "class", "flex-container mt-3");
			add_location(div4, file$1, 126, 4, 4278);
			add_location(main, file$1, 125, 0, 4267);
		},
		m: function mount(target, anchor) {
...
function instance$1($$self, $$props, $$invalidate) {
	...
	if ($$props && "$$inject" in $$props) {
	 ...
	 {
		const flipping = new Flipping({ easing: "cubic-bezier(.01, 0, .5, 1)" });
		...
		setTimeout(
			() => {
				...
				Array.from(document.querySelectorAll(".pointer"), button => {
					...
					button.addEventListener("click", flipping.wrap(() => {
...
//# sourceMappingURL=index-32aec052.js.map
